...
#define grub_zalloc(x) calloc((x), 1)

#define grub_malloc(sz) khook_kalloc(NULL, (sz), 1)
#define grub_memalign(align, sz) khook_kalloc(NULL, (sz), (align))
